...
void MainWindow::showCommandPalette() {
    ...
    commandPalette->openWith(UiHelpers::gatherCommands(this));
}
...
void MainWindow::showAbout() {
    QMessageBox::about(this, tr("關於 AlexCode"), UiHelpers::aboutHtml());
}
...
void MainWindow::showSettingsCenter() {
    ...
    SettingsDialog dlg(LspManager::configFilePath(), SnippetsController::configPath(),
                       keymapConfigPath(), UiHelpers::gatherShortcutActions(this), this);
    if (dlg.exec() != QDialog::Accepted) return;
    dlg.save();
